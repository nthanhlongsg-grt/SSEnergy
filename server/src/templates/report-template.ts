...
export function generateReportHTML(data: {
  ...
  const bilingualLabels: Record<string, { en: string; vi: string }> = {
    ...
    'report_generated': { en: 'Report automatically generated by Growatt Vietnam system', vi: 'Báo cáo được tạo tự động từ hệ thống Growatt Vietnam' },
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="header-left">
        ${logoUrl ? `<img src="${logoUrl}" alt="Growatt Logo" class="logo" />` : '<div class="logo-placeholder">GROWATT</div>'}
      </div>
    ...
    <div class="content">
      ...
      <div class="section">
        ...
        ${replacement_parts ? `
        <div style="margin-bottom: 24px;">
          <div class="section-title" style="font-size: 16px; margin-bottom: 12px;">${bilingual('replacement_parts')}</div>
          <div class="content-box">${escapeHtml(replacement_parts).replace(/\n/g, '<br>')}</div>
        </div>
        ` : ''}
      </div>
