...
export function generateReportHTML(data: {
  ...
  const bilingualLabels: Record<string, { en: string; vi: string }> = {
    ...
    'report_generated': { en: 'Report automatically generated by SS ENERGY system', vi: 'Báo cáo được tạo tự động từ hệ thống SS ENERGY' },
  ...
  <div class="container">
    ...
    <div class="header">
      <div class="header-left">
        ${logoUrl ? `<img src="${logoUrl}" alt="SSE Logo" class="logo" />` : '<div class="logo-placeholder">SSE</div>'}
      </div>
