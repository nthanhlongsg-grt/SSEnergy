# Hướng dẫn Deploy lên https://growattvietnam.com
...
**Lưu ý**: 
- Nếu backend chạy trên subdomain riêng (ví dụ: `api.growattvietnam.com`), sử dụng: `VITE_API_URL=https://api.growattvietnam.com`
- Nếu backend chạy cùng domain với frontend, sử dụng: `VITE_API_URL=https://growattvietnam.com/api`
...
```typescript
const CORS_ORIGIN = process.env.CORS_ORIGIN || 'https://growattvietnam.com'
```
...
server {
    listen 80;
    listen [::]:80;
    server_name growattvietnam.com www.growattvietnam.com;
...
1. Truy cập: https://growattvietnam.com
2. Kiểm tra:
